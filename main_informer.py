...
parser.add_argument('--data', type=str,
                    default='data011', help='data')
parser.add_argument('--root_path', type=str,
                    default='./data/', help='root path of the data file')
parser.add_argument('--data_path', type=str,
                    default='data1.csv', help='data file')
...
data_parser = {
    ...
    'data011': {'data': 'data1.csv', 'T': 'target', 'M': [11, 11, 11], 'S': [1, 1, 1], 'MS': [11, 11, 1]},
}
